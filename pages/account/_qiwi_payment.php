...
<h3><center><img src="/img/qiwi.png"></center></h3>



<?PHP
$_OPTIMIZATION["title"] = "Qiwi выплата";
...
<?PHP
 								...
 								if ($initOutput)
	{
				...
				<div style="width:260px; float:left; padding:21px 0px 0px 120px">
				<h5>Успешно!</h5>
				Вы получили выплату на ваш счет QIWI.
</div>
...
<?
				...
				<div style="width:260px; float:left; padding:21px 0px 0px 120px">
				<h4>Ошибка</h4>
				QIWI кошелек должен быть формата +79123456789. 
</div>
				<a class="close" title="Закрыть" onclick="document.getElementById('parent_popup').style.display='none';">X</a>
				  </div>
				</div>
...
<table border="0" align="center">
  <tbody><tr>
    <td align="right">Кошелек QIWI: </td>
	<td align="right"><input type="text" name="purse" class="box" placeholder="+79123456789" style="margin:0px; height:40px; width:170px;" size="15"></td>
  </tr>
  <tr>
