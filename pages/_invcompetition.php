...
?>
<div class="s-bk-lf">
	<div class="acc-title">Конкурс Инвесторов</div>
</div>
<div class="silver-bk"><div class="clr"></div>	
<center><a href="/invcompetition" class="stn">Текущие конкурсы</a> || <a href="/invcompetition/list" class="stn">Завершенные</a></center><BR />
<?PHP
...
В конкурсе учитываются все пополнения баланса, которые зарегистрировались после запуска конкурса. <BR />За каждое пополнение баланса Вам начисляются баллы, 1 RUB = 1 баллу. Чем больше баллов, тем больше шанс победить в конкурсе. <BR /><BR />
</b>
	<?PHP
	
	# Список пользователей
	$db->Query("SELECT * FROM db_invcompetition_users WHERE points > '0' ORDER BY points DESC LIMIT 100");
	if($db->NumRows() > 0){
