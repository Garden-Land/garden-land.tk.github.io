	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			n = DOM.add(o.iframeContainer, 'iframe', {
				id : t.id + "_ifr",
				src : u || 'javascript:""', // Workaround for http warning in IE6/7
				frameBorder : '0',
				style : {
					width : '100%',
					height : h
		...
		setupIframe : function() {
			...
			// IE needs to use contentEditable or it will display non secure items for http
			if (isIE) {
...
//				return TRUE;
			...
			sn = sn.nodeName == "HTML" ? d.body : sn; // Fix for Opera bug: http://bugs.opera.com/show_bug.cgi?id=273224&comments=yes
			sn = sn.nodeName == "BODY" ? sn.firstChild : sn;
			en = en.nodeName == "HTML" ? d.body : en; // Fix for Opera bug: http://bugs.opera.com/show_bug.cgi?id=273224&comments=yes
